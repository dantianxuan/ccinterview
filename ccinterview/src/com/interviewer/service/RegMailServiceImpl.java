...
public class RegMailServiceImpl extends TemplateOperate implements RegMailService {

    /** 日志Logger */
    private static final Logger logger = Logger.getLogger(RegMailServiceImpl.class);
