...
import com.interviewer.pojo.Category;
...
/**
	 ...
	 * @see com.interviewer.pojo.Category
...
public class CategoryDAO extends BaseHibernateDAO {
    ...
    public Category findById(java.lang.Integer id) {
        ...
        try {
            Category instance = (Category) getSession().get("com.interviewer.pojo.Category", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Category instance) {
        ...
        try {
            List results = getSession().createCriteria("com.interviewer.pojo.Category")
