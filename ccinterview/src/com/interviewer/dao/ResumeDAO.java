...
import com.interviewer.pojo.Resume;
...
/**
	 ...
	 * @see com.interviewer.pojo.Resume
...
public class ResumeDAO extends BaseHibernateDAO {
    ...
    public Resume findById(java.lang.Integer id) {
        ...
        try {
            Resume instance = (Resume) getSession().get("com.interviewer.pojo.Resume", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Resume instance) {
        ...
        try {
            List results = getSession().createCriteria("com.interviewer.pojo.Resume")
