...
/**
 * A data access object (DAO) providing persistence and search support for Prise
...
public class PriseDAO extends BaseHibernateDAO {
	...
	public Prise findById(java.lang.Integer id) {
		...
		try {
			Prise instance = (Prise) getSession().get(
					"com.interviewer.dao.Prise", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Prise instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.interviewer.dao.Prise")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Prise instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Prise as model where model."
					+ propertyName + "= ?";
